...
contract EONXR is ERC20 {
    string public constant symbol = "EXR";
    string public constant name = "Eon-XR Coin";
    uint8 public constant decimals = 18; //so in total supply to add 18 0 to indicate its decimal no.
